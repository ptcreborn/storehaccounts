...
var FLAG_API = {
    ...
    getCodefromIP: async function () {
        ...
        htmlOut = "<img style='vertical-align: middle; width: 24px !important;height: 24px !important;object-fit: cover;' src='" + flag_img + "'/><span style='font-weight: 600;'>" + country_name + " (" + country_code + ")</span>";
