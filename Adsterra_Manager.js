...
(async function () {
  // PLEASE ADD to array only BANNER!
    let adsProperty = [[
        ...
        [
            "adsterra_mid",
            "atOptions = { 'key' : 'cc3b17b3d88c95500f8a72553d34420b', 'format' : 'iframe', 'height' : 90, 'width' : 720, 'params' : {} };",
            "//www.highperformanceformat.com/cc3b17b3d88c95500f8a72553d34420b/invoke.js"
        ]
    ];
